...
namespace WarLightAi.Bot
{
    public class GameState
    {
        ...
        private Map visibleMap = new Map(); // This map represents everything the player can see, updated at the end of each round.
        ...
        private List<Move.Move> opponentMoves; // List of all the opponent's moves, reset at the end of each round
        ...
        public GameState()
        {
            ...
            opponentMoves = new List<Move.Move>();
            roundNumber = 0;
        }
        ...
        public void UpdateMap(String[] mapInput)
        {
            ...
            foreach (var region in visibleMap.Regions)
                if (region.PlayerName == Constants.UnknownPlayerName)
        ...
        public static String GetOpponentPlayerName
        {
        ...
        public List<Move.Move> OpponentMoves
        {
